        ...
        <table >
            ...
            @foreach($exams as $exam)
                <tr>
                    ...
                    <td style="border:1px solid #000; text-align: center;">&nbsp;{{ $exam->subject->name }}</td>
                    <td style="border:1px solid #000; text-align: center;">&nbsp;{{ $exam->subject->code }}</td>
                    <td style="border:1px solid #000; text-align: center;">&nbsp;{{ $exam->time }}</td>
                    <td style="border:1px solid #000; text-align: center;">&nbsp;{{ $exam->room }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
        ...
        <table style="width: 100%; border: none; border-collapse: collapse; margin-top: 30px;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top; text-align: center;">
                    ...
                    <p style="margin-top:30px;"><b><?= \Illuminate\Support\Facades\Auth::user()->name ?></b></p>
                </td>
